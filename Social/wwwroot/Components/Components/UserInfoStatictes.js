...
var Custom_KTWidgets = function () {
    var initUseresEnableGhostModeRate = function (UsersInfo) {
        ...
        var options = {
            labels: ["users enable ghost mode percentage"],
    ...
    var initVerifiedUsersRate = function (UsersInfo) {
        var element = document.getElementById("VerifiedUsersRate");
        var height = parseInt(KTUtil.css(element, 'height'));
        if (!element) {
            return;
        }
        var options = {
            labels: ["verified users percentage"],
            series: [UsersInfo.UsersVertified_Rate],
            chart: {
                fontFamily: 'inherit',
                height: 300,
                type: 'radialBar',
    ...
    return {
        init: function (UsersInfo) {
            initVerifiedUsersRate(UsersInfo);
...
var KTProjectOverview = function () {
    ...
    var initChart = function (UsersInfo) {
        ...
        var config = {
            ...
            data: {
                datasets: [{
                    data: [(UsersInfo.ConfirmedMailUsers_Count), (UsersInfo.UnConfirmedMailUsers_Count), (UsersInfo.DeletedUsers_Count)],
                    backgroundColor: ['#009EF7', '#E4E6EF', '#D9214E']
                }],
                labels: ['Mail Confirmed', 'Mail NotConfirmed', 'DeActive ']
            },
            options: {
                chart: {
                    fontFamily: 'inherit'
...
var allUserStatictesInfo = function () {
    ...
    var initallUserStatictesInfo = function (UsersInfo) {
        let Series = [
            { lable: 'registered useres', serie: UsersInfo.TotalUsers_Count, color: '#35F434' },
            { lable: 'deleted accounts', serie: UsersInfo.DeletedUsers_Count, color: '#F74634' },
            { lable: 'users who have accounts but not active on the app', serie: UsersInfo.NotactiveUsers_Count, color: '#0039FF' },
            ...
            { lable: 'Users with personal space enabled', serie: UsersInfo.personalspace, color: '#fff8dd' },
        ]
        var options = {
        ...
        var chart = new ApexCharts(document.querySelector("#allUserStatictes"), options);
        chart.render();
