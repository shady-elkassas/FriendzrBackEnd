...
// Class definition
var KTUsersReportsViewRole = function () {
    // Shared variables
    var datatable;
    var table;
    var SearchSelector;
...
KTUtil.onDOMContentLoaded(function () {
    KTEventsViewRole.init("#EventReportsTable", "#EventReportsSearchInTable[data-kt-roles-table-filter='search']");

    KTUsersReportsViewRole.init("#UserReportsTable", "#UserReportsSearchInTable[data-kt-roles-table-filter='search']");
});